...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str,default="/root/autodl-tmp/DataSet/mini-ImageNet", help='dataset path')
    ...
    parser.add_argument('--pretrain_path', default='./checkpoints/mini_imagenet/ResNet12_protonet_pretrain/best_model.tar', help='pre-trained model .tar file path')
    ...
    # model save path
    params.checkpoint_dir = './checkpoints/%s_AP/%s_%s' % (params.dataset, params.model, params.method)
    ...
    if not os.path.isdir(params.checkpoint_dir):
        os.makedirs(params.checkpoint_dir)
    print(params)
    print("SADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD")
